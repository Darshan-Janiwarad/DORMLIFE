...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])) {
    ...
    $search_query = "SELECT * FROM students_g WHERE csn_usn LIKE ?";
    ...
    // Fetch all students from block G
    $query_v = "SELECT * FROM students_g";
...
<head>
    ...
    <title>Admin Dashboard - Block G</title>
    <style>
        body {
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-content">
            <a href="g_anc.php" class="btn">Send Announcements</a>
            <a href="../admins/viewancg.php" class="btn">View Announcements</a>
            <a href="g_comp.php" class="btn">View Complaints</a>
            <a href="view_room_bookingg.php" class="btn">View Bookings</a>
    ...
    <div class="dashboard-container">
        ...
        <a href="../register_student/register_g.php" class="btn">Register Student for Block G</a>
        <h3>List of Students in Block G</h3>
                ...
                <tbody>
                    <?php while ($row = $search_results->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../admins/edit_studentg.php?id=<?php echo $row['StudentID']; ?>" class="btn-e">Edit</a>
                                <a href="../admins/delete_studentg.php?id=<?php echo $row['StudentID']; ?>&name=<?php echo urlencode($row['Name']); ?>"
                                    class="btn-d"
