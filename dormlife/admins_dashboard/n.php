...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])) {
    ...
    $search_query = "SELECT * FROM students_n WHERE csn_usn LIKE ?";
    ...
    // Fetch all students from block N
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-content">
            <a href="n_anc.php" class="btn">Send Announcements</a>
            <a href="../admins/viewancn.php" class="btn">View Announcements</a>
            <a href="n_comp.php" class="btn">View Complaints</a>
            <a href="view_room_bookingn.php" class="btn">View Bookings</a>
    ...
    <div class="dashboard-container">
        ...
        <a href="../register_student/register_n.php" class="btn">Register Student for Block N</a>
                ...
                <tbody>
                    <?php while ($row = $search_results->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../admins/edit_studentn.php?id=<?php echo $row['StudentID']; ?>" class="btn-e">Edit</a>
                                <a href="../admins/delete_studentn.php?id=<?php echo $row['StudentID']; ?>&name=<?php echo urlencode($row['Name']); ?>"
                                    class="btn-d"
