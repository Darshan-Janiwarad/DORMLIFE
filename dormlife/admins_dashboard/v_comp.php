...
$query_complaints = "SELECT * FROM vblock_complaints";
...
<head>
    ...
    <title>View Complaints - Block V</title>
    <style>
        body {
...
<body>
    <div class="navbar">
        <h1>Block V Complaints</h1>
        <a href="v.php" class="btn">Back to Dashboard</a>
    </div>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <p>No complaints found for Block V.</p>
        <?php endif; ?>
    </div>
</body>
