...
if (!isset($_SESSION['student_department'])) {
    $stmt = $conn->prepare("SELECT department FROM students_n WHERE username = ?");
...
<head>
    ...
    <title>N Block Hostel - Student Dashboard</title>
    <style>
        body {
...
<body>
    <div class="navbar">
        <h1>N Block Hostel</h1>
        <span class="toggle" onclick="toggleMenu()">☰</span>
        <ul>
            <li><a href="javascript:void(0)" onclick="toggleAbout()">About</a></li>
            <li><a href="../complaints/ncomplaints.php">Raise an Issue</a></li>
            <li><a href="ncomp.php">Notifications</a></li>
    ...
    <div class="content">
        ...
        <p>
            Discover a safe and vibrant living space at the N Block Hostel. Designed for both comfort and convenience,
            our hostel offers the ideal environment for students.
        </p>
        <p>
            Located close to key academic buildings, N Block provides state-of-the-art facilities, excellent dining
