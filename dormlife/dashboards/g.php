...
if (!isset($_SESSION['student_department'])) {
    $stmt = $conn->prepare("SELECT department FROM students_g WHERE username = ?");
...
<body>
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="../complaints/gcomplaints.php">Raise an Issue</a></li>
            <li><a href="gcomp.php">Notifications</a></li>
    ...
    <div class="content">
        ...
        <p>
            Discover a safe and vibrant living space at the G Block Hostel. Designed for both comfort and convenience,
            our hostel offers the ideal environment for students.
        </p>
        <p>
            Located close to key academic buildings, G Block provides state-of-the-art facilities, excellent dining
            options, and a thriving student community.
        </p>

        <!-- About Section -->
        <div id="about-section" class="about-section">
            <h3>Malaprabha Ladies Hostel</h3>
            <p>The hostel was started in the year 1998 to accommodate the students of Basaveshwar Engineering College Bagalkot. The hostel is well equipped with all requisite facilities to cater to the needs of all Girl students. The total number of rooms available in the hostel are 190 with a total capacity of 468 students.
            </p>
        </div>

        <!-- Department Dropdown -->
        <div class="dropdown">
            <form action="../book_bed_g/search_roomsg.php" method="POST">
