...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query = "SELECT * FROM students_v WHERE Username=?";
    ...
    $check_query1 = "SELECT * FROM students_v WHERE csn_usn=?";
    ...
    if ($username_exists) {
        ...
        $insert_query = "INSERT INTO students_v (Name, Phone_no, Department, Year, Address, csn_usn, Username, Password, RegisteredBy) 
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
            ...
            header("Location: ../admins_dashboard/v.php");
            exit();
        } else {
...
<head>
    ...
    <title>Register Student for Block V</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h2>Register Student for Block V</h2>
