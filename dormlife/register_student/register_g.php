...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_query1 = "SELECT * FROM students_g WHERE csn_usn=?";
    ...
    if ($username_exists) {
        ...
        $insert_query = "INSERT INTO students_g (Name, Phone_no, Department, Year, Address, csn_usn, Username, Password, RegisteredBy) 
                         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
