...
if (isset($_GET['delete_id'])) {
    ...
    $sql = "DELETE FROM g_announcements WHERE id = $delete_id";
    if (mysqli_query($conn, $sql)) {
        echo "<script>
                alert('Announcement deleted successfully.');
                window.location.href = 'viewancg.php';
              </script>";
    } else {
        echo "<script>
...
$sql = "SELECT * FROM g_announcements ORDER BY posted_at DESC";
...
<head>
    ...
    <title>Admin Announcements - G Block</title>
    <style>
        body {
...
<h1>Admin Announcements - G Block</h1>
...
<?php else: ?>
    <p>No announcements found for G Block.</p>
<?php endif; ?>
