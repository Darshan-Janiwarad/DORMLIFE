...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $get_student_query = "SELECT Username FROM students_n WHERE StudentID = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $update_booking_query = "UPDATE nblock_beds SET is_booked = 0, student_name = NULL WHERE student_name = ?";
            ...
            // Delete the student record from the students_n table
            $delete_student_query = "DELETE FROM students_n WHERE StudentID = ?";
            ...
            header("Location: ../admins_dashboard/n.php"); // Modify this to redirect to the appropriate page
            exit();
        } else {
