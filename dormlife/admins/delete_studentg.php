...
if (isset($_GET['id'])) {
    ...
    try {
        // Retrieve the student's name from the students_g table
        $get_student_query = "SELECT Username FROM students_g WHERE StudentID = ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $update_booking_query = "UPDATE gblock_beds SET is_booked = 0, student_name = NULL WHERE student_name = ?";
            ...
            // Delete the student record from the students_g table
            $delete_student_query = "DELETE FROM students_g WHERE StudentID = ?";
            ...
            header("Location: ../admins_dashboard/g.php"); // Modify this to redirect to the appropriate page
            exit();
        } else {
