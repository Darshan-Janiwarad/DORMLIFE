...
if (isset($_GET['delete_id'])) {
    ...
    $sql = "DELETE FROM v_announcements WHERE id = $delete_id";
    if (mysqli_query($conn, $sql)) {
        echo "<script>
                alert('Announcement deleted successfully.');
                window.location.href = 'viewancv.php';
              </script>";
    } else {
        echo "<script>
...
// Fetch announcements for V-block
$sql = "SELECT * FROM v_announcements ORDER BY posted_at DESC";
...
<head>
    ...
    <title>Admin Announcements - V Block</title>
    <style>
        body {
...
<div class="navbar">
        <a href="../admins_dashboard/v.php" class="btn">Back to Dashboard</a>
    </div>
<body>

<h1>Admin Announcements - V Block</h1>
...
<?php else: ?>
    <p>No announcements found for V Block.</p>
<?php endif; ?>
